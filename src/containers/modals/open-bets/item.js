            ...
            <div className="btable__row">
                ...
                <div className="btable__col">
                    <div className="btable__btns">
                        ...
                        <button
                            onClick={e => handleCashOutList(bet)}
                            className={`details__btn details__btn--${parseFloat(bet?.profit || 0) >= 0 ? 'green' : 'white'}`}
                            type="button"
                        >
                            X
                        </button>
