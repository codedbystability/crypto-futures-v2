...
const Header = () => {
    ...
    const {activeLanguage, languages} = useSelector(state => state.appearanceReducer)
    ...
    const handleHome = () =>
        window?.open('https://updown.osugczihbllcmgbzjpjvqhplpbwzfxsipkmtrvaiblvykvuqgnvvnzfxdmyi.com?direct_auth=' + gup('direct_auth', window.location.href), '_self')
                    ...
                    <div className="col-12">
                        <div className="header__content">
                            <a onClick={handleHome} className="header__logo">
                                <img src="img/cryptofutures.svg" alt=""/>
                            </a>
